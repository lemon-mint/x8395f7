function _mul64(x, y) {
    ...
    const hi = BigInt.asUintN(64, BigInt.asUintN(64, BigInt.asUintN(64, x1 * y1) + w2) +
...
function _wyhash(key, seed, secret) {
    ...
    if (len <= 16) {
        if (len >= 4) {
            a = BigInt.asUintN(64, BigInt.asUintN(64, _wyr4(key, p) << BigInt(32)) |
                BigInt.asUintN(64, _wyr4(key, (p + ((len >>> 3) << 2)))));
            b = BigInt.asUintN(64, BigInt.asUintN(64, _wyr4(key, p + len - 4) << BigInt(32)) |
